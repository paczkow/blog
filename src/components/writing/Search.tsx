...
export const Search = ({
  ...
  return (
    <div className="col-span-full flex flex-col flex-1 lg:contents">
      <div className="shrink-0 mb-8 flex flex-col gap-4 lg:sticky lg:top-(--nav-height) lg:col-start-1 lg:col-end-2 lg:mb-0 lg:h-[calc(100vh-242px)]">
      ...
      <div className="flex-1 flex flex-col gap-12 lg:col-start-2 lg:col-end-3 mr-[2px]">
